 ...
 */
public class MenuInfMisc extends ActionBarActivity{
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_infographicmisc);
    ...
    public void addButtonClickListener() {
        ...
        btnNavigator.setOnClickListener(new View.OnClickListener() {
            public void onClick(View arg) {
                Intent intent = new Intent(MenuInfMisc.this, myapplication.example.com.healthlifehack.Infograph.class);
