 ...
 */
public class MenuInfSeizure extends ActionBarActivity{
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_inforgraphicsei);
    ...
    public void addButtonClickListener() {
        ...
        btnNavigator.setOnClickListener(new View.OnClickListener() {
            public void onClick(View arg) {
                Intent intent = new Intent(MenuInfSeizure.this, myapplication.example.com.healthlifehack.Infograph.class);
